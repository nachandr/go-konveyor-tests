				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: "<groupId>javax</groupId>",
					},
					{
						File:     "/shared/source/coolstore/pom.xml",
						Line:     25,
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: "<artifactId>javaee-api</artifactId>",
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: "<artifactId>javaee-web-api</artifactId>",
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: "<property name='javax.persistence.schema-generation.database.action' value='none'/>",
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: `<beans xmlns="http://xmlns.jcp.org/xml/ns/javaee" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"`,
					},
					{
						File:     "/shared/source/coolstore/src/main/webapp/WEB-INF/beans.xml",
						Line:     20,
						Message:  "Replace `http://xmlns.jcp.org/xml/ns/javaee` with `https://jakarta.ee/xml/ns/jakartaee` and change the schema version number",
						CodeSnip: `http://xmlns.jcp.org/xml/ns/javaee`,
					},
					{
						File:     "/shared/source/coolstore/src/main/webapp/WEB-INF/beans.xml",
						Line:     21,
						Message:  "Replace `http://xmlns.jcp.org/xml/ns/javaee` with `https://jakarta.ee/xml/ns/jakartaee` and change the schema version number",
						CodeSnip: `http://xmlns.jcp.org/xml/ns/javaee/beans_1_1.xsd"`,
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: `xmlns="http://xmlns.jcp.org/xml/ns/persistence" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"`,
					},
					{
						File:     "/shared/source/coolstore/src/main/resources/META-INF/persistence.xml",
						Line:     5,
						Message:  "Replace `http://xmlns.jcp.org/xml/ns/persistence` with `https://jakarta.ee/xml/ns/persistence` and change the schema version number",
						CodeSnip: "http://xmlns.jcp.org/xml/ns/persistence",
					},
					{
						File:     "/shared/source/coolstore/src/main/resources/META-INF/persistence.xml",
						Line:     6,
						Message:  "Replace `http://xmlns.jcp.org/xml/ns/persistence` with `https://jakarta.ee/xml/ns/persistence` and change the schema version number",
						CodeSnip: `http://xmlns.jcp.org/xml/ns/persistence/persistence_2_1.xsd">`,
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: `<persistence version="2.1"`,
					},
					{
						File:     "/shared/source/coolstore/src/main/resources/META-INF/persistence.xml",
						Line:     8,
						Message:  "In the root tag, replace the `version` attribute value `2.1` with `3.0`",
						CodeSnip: `<jta-data-source>java:jboss/datasources/CoolstoreDS</jta-data-source>`,
					},
				},
			},
			{
				...
				Incidents: []api.Incident{
					{
						...
						CodeSnip: `import javax.persistence.Column;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/InventoryEntity.java",
						Line:     6,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.Entity;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/InventoryEntity.java",
						Line:     7,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistenc`e",
						CodeSnip: `import javax.persistence.Id;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/InventoryEntity.java",
						Line:     8,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.Table;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/InventoryEntity.java",
						Line:     9,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.UniqueConstraint;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/InventoryEntity.java",
						Line:     10,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.xml`",
						CodeSnip: `import javax.xml.bind.annotation.XmlRootElement;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     7,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.CascadeType;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     8,
					...
					},
					{
						...
						Line:     10,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.FetchType;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     11,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.GeneratedValue;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     12,
					...
					},
					{
						...
						Line:     13,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.JoinColumn;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     14,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.OneToMany;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/model/Order.java",
						Line:     15,
					...
					},
					{
						...
						CodeSnip: `import javax.enterprise.context.Dependent;`,
					},
					{
					...
					},
					{
						...
						Line:     4,
						Message:  "Replace the `javax.enterprise` import statement with `jakarta.enterprise`",
						CodeSnip: `import javax.enterprise.inject.Produces;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/persistence/Resources.java",
						Line:     5,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.EntityManager;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/persistence/Resources.java",
						Line:     5,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.PersistenceContext;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     9,
						Message:  "Replace the `javax.enterprise` import statement with `jakarta.enterprise`",
						CodeSnip: `import javax.enterprise.context.SessionScoped;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     10,
					...
					},
					{
						...
						CodeSnip: `import javax.ws.rs.DELETE;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     12,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.GET;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     13,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.POST;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     14,
					...
					},
					{
						...
						Line:     15,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.PathParam;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     16,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.Produces;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/CartEndpoint.java",
						Line:     17,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.core.MediaType;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/OrderEndpoint.java",
						Line:     6,
						Message:  "Replace the `javax.enterprise` import statement with `jakarta.enterprise`",
						CodeSnip: `import javax.enterprise.context.RequestScoped;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/OrderEndpoint.java",
						Line:     7,
					...
					},
					{
						...
						Line:     8,
						Message:  "Replace the `javax.ws` import statement with `jakarta.ws`",
						CodeSnip: `import javax.ws.rs.Consumes;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/OrderEndpoint.java",
						Line:     9,
					...
					},
					{
						...
						Line:     9,
						Message:  "Replace the javax.inject import statement with jakarta.inject",
						CodeSnip: `Replace the javax.ws import statement with jakarta.ws`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/RestApplication.java",
						Line:     3,
						Message:  "Replace the javax.ws import statement with jakarta.ws",
						CodeSnip: `import javax.ws.rs.ApplicationPath;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/rest/RestApplication.java",
						Line:     4,
						Message:  "Replace the javax.ws import statement with jakarta.ws",
						CodeSnip: `import javax.ws.rs.core.Application;`,
					},
					{
					...
					},
					{
						...
						Line:     8,
						Message:  "Replace the javax.persistence import statement with jakarta.persistence",
						CodeSnip: `import javax.persistence.criteria.CriteriaBuilder;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/service/CatalogService.java",
						Line:     9,
						Message:  "Replace the javax.persistence import statement with jakarta.persistence",
						CodeSnip: `import javax.persistence.criteria.CriteriaQuery;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/service/CatalogService.java",
						Line:     10,
						Message:  "Replace the `javax.persistence` import statement with `jakarta.persistence`",
						CodeSnip: `import javax.persistence.criteria.Root;`,
					},
					{
						File:     "/shared/source/coolstore/src/main/java/com/redhat/coolstore/service/CatalogService.java",
						Line:     13,
